            ...
            <div className='h-10 flex justify-between items-center bg-[#EBEFF3]'>
                <div className="hidden md:block">
                    <ul className='flex justify-between items-center gap-7 p-4 ml-[130px]'>
                        <li><FontAwesomeIcon icon={faLocationDot} /> Tashkent</li>
                        <li><p>About Us</p></li>
                        <li><p>Products</p></li>
                        <li><p>Contact</p></li>
                    </ul>
                    ...
                    <ul className='flex justify-between items-center gap-7 md:p-4 mr-[80px]'>
                        ...
                        <li className="md:block hidden">
                            <Select>
                                ...
                                <SelectContent>
                                    <SelectGroup>
                                        <SelectItem className='bg-white' value="uz">Uz</SelectItem>
                                        <SelectItem className='bg-white' value="eng">Eng</SelectItem>
                                        <SelectItem className='bg-white' value="rus">Rus</SelectItem>
                                    </SelectGroup>
                                </SelectContent>
                            </Select>
                        </li>
